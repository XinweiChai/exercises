...
with open('E:\\test.txt', encoding='utf8') as f:
    text1 = f.readlines()
# 导入图片
image1 = PIL.Image.open('E:\\picture.png')
MASK = np.array(image1)
WC = wordcloud.WordCloud(font_path='C:\\Windows\\Fonts\\STFANGSO.TTF', max_words=2000, mask=MASK, height=400, width=400,
