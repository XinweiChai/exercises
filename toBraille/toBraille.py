...
class KanjiToPinyin(object):
    def __init__(self):
        ...
        self.yunmu_table = ['a', 'o', 'e', 'i', 'u', 'v', 'ai', 'ei', 'ui', 'ao', 'ou', 'iu', 'ie', 'ue', 'er', 'an',
                            'en', 'in', 'un',
                            'vn', 'ang', 'eng', 'ing', 'ong', 'ia', 'ian', 'iang', 'iao', 'iong', 'uai', 'ua', 'ue',
                            'uan', 'uang', 'uo', 'van']
    ...
    def get_pinyin(self, character):
        ...
        pinyin_with_tone = p.get_pinyin(self.character.string, tone_marks='marks', convert='lower')
                ...
                if letter in tones[1]:
                    ...
                    if i != 0:
                        if i + 1 != len(self.character.pinyin):
                            self.character.pinyin_notone = self.character.pinyin[0:i] + self.tone_table[0][1][
                                j] + self.character.pinyin[i + 1:]
                        else:
...
class Pinyin2Braille:
    def __init__(self):
        ...
        self.yunmu_trans_table = [
            ...
            ('ong', '4'), ('ian', '%'), ('ia', '$'), ('iang', 'x'), ('iao', '>'), ('iong', '?'), ('uai', 'y'),
            ('ua', '='),
            ('uan', ']'), ('uang', '7'), ('uo', 'o'), ('van', '&'),
        ]
        ...
        self.figure_table = ['a', '1', 'b', "'", 'k', '2', 'l', '`', 'c', 'i', 'f', '/', 'm', 's', 'p', '"', 'e', '3',
                             'h', '9', 'o', '6', 'r', '^', 'd', 'j', 'g', '>', 'n', 't', 'q', ',', '*', '5', '<', '-',
                             'u', '8', 'v', '.', '%', '[', '$', '+', 'x', '!', '&', ';', ':', '4', '\\', '0', 'z', '7',
                             '(', '_', '?', 'w', ']', '#', 'y', ')', '=']
