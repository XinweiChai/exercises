...
def rand_excel(fn):
    ...
    for k in range(15, 30):
        sheet.cell(2, 1, num_spaces * ' ' + "日期：2020年2月" + str(k) + "日")
        ...
        workbook.save("C:/Users/Administrator/Desktop/202002" + str(k) + ".xlsx")


if __name__ == "__main__":
	# rand_excel("C:/Users/Administrator/Desktop/20200229.xlsx")